...
public class UnicastOUCHSoupBinTCP {
    ...
    public UnicastOUCHSoupBinTCP(String username, String password, String session, String host, int port, long sequenceNumber, Decoder.Potocol protocol) throws IOException {
        ...
        if (clientSocket != null) {
            ...
            if (clientSocket.isConnected() == true) {
                ...
                try {
                    ...
                    System.out.println("[SoupBinTCP-OUT] Unsequenced Packet ");
        ...
        if (clientSocket != null) {
            if (clientSocket.isConnected() == true) {
                try {
                    ...
                    System.out.println("[SoupBinTCP-OUT] Uncequenced Packet ");
    ...
    public static void usage() {
        System.out.println("Usage: java UnicastServices <username> <password> <session> <hostname> <port> <seqnum>");
        System.out.println("");
        ...
        System.out.println("   session   - session id the client wishes to log into, setting \" \" indicates the current session (10 characters right padded with spaces)");
    ...
    public static void StartHandling(String[] args) throws IOException, UnsupportedLookAndFeelException {
        ...
        Decoder.DecoderOuchBIVA.count_accepted_message = 0;
        Decoder.DecoderOuchBIVA.count_broken_trade = 0;
        count_cancel_order = 0;
        Decoder.DecoderOuchBIVA.count_cancelled_order = 0;
        count_enter_order = 0;
        Decoder.DecoderOuchBIVA.count_executed_order = 0;
        Decoder.DecoderOuchBIVA.count_rejected_message = 0;
        count_replace_order = 0;
        Decoder.DecoderOuchBIVA.count_replaced_order = 0;
        Decoder.DecoderOuchBIVA.count_system_event = 0;
        if (args.length != 7) {
            usage();
            args = new String[6];
        ...
        try {
            ...
            final UnicastOUCHSoupBinTCP s = new UnicastOUCHSoupBinTCP(args[0], args[1], args[2], args[3], Integer.parseInt(args[4]), Long.parseLong(args[5]), new Decoder.DecoderOuchBIVA());
